  ...
  <div class="commerce">
    ...
    <div class="commerce-advantage">
      <div class="commerce-advantage__title">
        <img src="commerce01.png" />
        高效
      </div>
      <div class="commerce-advantage__01">
        <div class="commerce-advantage__01-item">
          <img src="advantage1.png"/>
          融合管理
        </div>
        <div class="commerce-advantage__01-item">
          <img src="advantage2.png"/>
          随处运营
        </div>
        <div class="commerce-advantage__01-item">
          <img src="advantage3.png"/>
          在线文档
        </div>
      </div>
...
.commerce-bottom {
  background: url('/commercebottombg.png') no-repeat bottom left;
  background-size: 100% ;
